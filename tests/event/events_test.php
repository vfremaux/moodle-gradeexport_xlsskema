...
namespace gradeexport_xlsskema\event;
...
class events_test extends \advanced_testcase {
    ...
    public function test_logging() {
        ...
        $event = \gradeexport_xlsskema\event\grade_exported::create($params);
        ...
        $this->assertInstanceOf('\gradeexport_xlsskema\event\grade_exported', $event);
