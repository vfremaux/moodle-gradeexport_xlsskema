...
$PAGE->set_url('/grade/export/xlsskema/export.php', array('id' => $id));
...
if (!empty($CFG->gradepublishing) && !empty($key)) {
    $actionbar = new \core_grades\output\export_publish_action_bar($context, 'xlsskema');
...
$export = new grade_export_xlsskema($course, $groupid, $formdata);
